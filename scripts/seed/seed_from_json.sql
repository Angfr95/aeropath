-- ============================================================================
-- SEED FROM JSON : 9 modules chargés depuis content/fr/ppl/air_law/
...
INSERT INTO lessons (id, license, category, theme, title_fr, title_en, content_fr, content_en, difficulty, order_index, level, duration_minutes, tags, learning_objectives) VALUES
('621491b7-0000-4000-8000-0000621491b7', 'PPL', 'air law', 'air law', 'Règles de vol (VFR/IFR)', 'Flight Rules (VFR/IFR)', '', '', 2, 4, 1, 30, '["VFR","IFR","flight rules","SERA"]', '[]');

INSERT INTO lessons (id, license, category, theme, title_fr, title_en, content_fr, content_en, difficulty, order_index, level, duration_minutes, tags, learning_objectives) VALUES
('621491b8-0000-4000-8000-0000621491b8', 'PPL', 'air law', 'air law', 'SERA — Règles de l''air standardisées', 'SERA — Standardised European Rules of the Air', '', '', 2, 5, 1, 35, '["SERA","rules","Europe","EASA"]', '[]');

INSERT INTO lessons (id, license, category, theme, title_fr, title_en, content_fr, content_en, difficulty, order_index, level, duration_minutes, tags, learning_objectives) VALUES
('621491b9-0000-4000-8000-0000621491b9', 'PPL', 'air law', 'air law', 'Planification de vol et dépôt de plan de vol', 'Flight Planning and Flight Plan Filing', '', '', 2, 6, 1, 25, '["flight plan","planning","AIS","NOTAM"]', '[]');

INSERT INTO lessons (id, license, category, theme, title_fr, title_en, content_fr, content_en, difficulty, order_index, level, duration_minutes, tags, learning_objectives) VALUES
('621491ba-0000-4000-8000-0000621491ba', 'PPL', 'air law', 'air law', 'Services de la circulation aérienne (ATC)', 'Air Traffic Services (ATC)', '', '', 2, 7, 1, 30, '["ATC","ATS","control","approach","area"]', '[]');

INSERT INTO lessons (id, license, category, theme, title_fr, title_en, content_fr, content_en, difficulty, order_index, level, duration_minutes, tags, learning_objectives) VALUES
('621491bb-0000-4000-8000-0000621491bb', 'PPL', 'air law', 'air law', 'Procédures d''urgence et de détresse', 'Emergency and Distress Procedures', '', '', 3, 8, 1, 25, '["emergency","distress","MAYDAY","PAN-PAN","Squawk"]', '[]');

INSERT INTO lessons (id, license, category, theme, title_fr, title_en, content_fr, content_en, difficulty, order_index, level, duration_minutes, tags, learning_objectives) VALUES
('621491d1-0000-4000-8000-0000621491d1', 'PPL', 'air law', 'air law', 'Documents de bord et licences', 'Onboard Documents and Licenses', '', '', 1, 9, 1, 20, '["documents","licenses","logbook","certificates"]', '[]');
...
-- ============================================================================
-- RÉSUMÉ: 9 modules, 9 concepts, 45 questions
-- ============================================================================
